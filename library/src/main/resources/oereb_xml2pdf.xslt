	...
	<xsl:if test="(../data:ConcernedTheme)">
		...
		<fo:flow flow-name="xsl-region-body">
			<fo:block>
                ...
                <xsl:sort data-type="number" order="ascending" select="(number(data:SubTheme='ch.SO.NutzungsplanungGrundnutzung') * 0.901) + (number(data:SubTheme='ch.SO.NutzungsplanungUeberlagernd') * 0.902) + (number(data:SubTheme='ch.SO.NutzungsplanungSondernutzungsplaene') * 0.903) + (number(data:SubTheme='ch.SO.Baulinien') * 0.904) + (number(data:Theme/data:Code='LandUsePlans') * 1) + (number(data:Theme/data:Code='MotorwaysProjectPlaningZones') * 2) + (number(data:Theme/data:Code='MotorwaysBuildingLines') * 3) + (number(data:Theme/data:Code='RailwaysProjectPlanningZones') * 4) + (number(data:Theme/data:Code='RailwaysBuildingLines') * 5) + (number(data:Theme/data:Code='AirportsProjectPlanningZones') * 6) + (number(data:Theme/data:Code='AirportsBuildingLines') * 7) + (number(data:Theme/data:Code='AirportsSecurityZonePlans') * 8) + (number(data:Theme/data:Code='ContaminatedSites') * 9) + (number(data:Theme/data:Code='ContaminatedMilitarySites') * 10) + (number(data:Theme/data:Code='ContaminatedCivilAviationSites') * 11) + (number(data:Theme/data:Code='ContaminatedPublicTransportSites') * 12) + (number(data:Theme/data:Code='GroundwaterProtectionZones') * 13) + (number(data:Theme/data:Code='GroundwaterProtectionSites') * 14) + (number(data:Theme/data:Code='NoiseSensitivityLevels') * 15) + (number(data:Theme/data:Code='ForestPerimeters') * 16) + (number(data:Theme/data:Code='ForestDistanceLines') * 17) + (number(data:Theme/data:Code='ch.SO.Einzelschutz') * 20)"/>					<xsl:if test="current-group()/data:SubTheme">
